...
import {RemovableRefList} from '../src/misc/removablereflist';

suite('RemovableRefList', () => {

	let refs: RemovableRefList<Object>;

	setup(() => {
		refs = new RemovableRefList<Object>();
	});
	...
	test('removeObjects', () => {
		const rs = new RemovableRefList<Object>();
	...
	test('removeObjects and addObject', () => {
		const rs = new RemovableRefList<Object>();
		const r1 = rs.addObject(new Object());
		/*const r2 = */ rs.addObject(new Object());
		const r3 = rs.addObject(new Object());
