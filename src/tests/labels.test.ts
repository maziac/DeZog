...
*/
	...
	suite('Files/lines vs list file', () => {
		...
		test('getFileAndLineForAddress', () => {
			Labels.loadAsmListFile('./src/tests/data/test1.list', [""], undefined, "z80asm", 0, false);
			Labels.finish();
		...
		test('get label values from list file', () => {
			Labels.loadAsmListFile('./src/tests/data/test2.list', [""], undefined, "z80asm", 0, true);
			Labels.finish();
		...
		test('address offset', () => {
			Labels.loadAsmListFile('./src/tests/data/test2.list', [""], undefined, "z80asm", 0x1000, true);
			Labels.finish();
