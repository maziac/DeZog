...
import { zSocket, ZesaruxSocket } from '../zesarux/zesaruxSocket';
...
import { ZesaruxRegisters } from '../zesarux/zesaruxregisters';
...
export class ZxNextRemote extends RemoteClass {
	...
	protected initBreakpoints() {
		...
		for (var i = 1; i <= ZxNextRemote.MAX_USED_BREAKPOINTS; i++)
