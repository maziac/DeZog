...
export class MemoryModelZX81_1k extends MemoryModel {
	constructor() {
		super({
			slots: [
				{
...
export class MemoryModelZX81_2k extends MemoryModel {
	constructor() {
		super({
			slots: [
				{
...
export class MemoryModelZX81_16k extends MemoryModel {
	constructor() {
		super({
			slots: [
				{
...
export class MemoryModelZX81_32k extends MemoryModel {
	constructor() {
		super({
			slots: [
				{
...
export class MemoryModelZX81_48k extends MemoryModel {
	constructor() {
		super({
			slots: [
				{
...
export class MemoryModelZX81_56k extends MemoryModel {
	constructor() {
		super({
			slots: [
				{
