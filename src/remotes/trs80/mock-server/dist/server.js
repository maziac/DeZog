...
class MockTrs80gpServer {
    ...
    constructor(port) {
        ...
        this.use8BitRegistersOnly = false;
    ...
    handleJsonRpcMessage(message, socket) {
        ...
        switch (message.method) {
            ...
            case 'setRegister':
                if (message.params && typeof message.params.register === 'string' &&
                    ...
                    if (reg in this.emulatorState.registers) {
                        ...
                        this.emulatorState.registers[reg] = value;
                        response = {
                            jsonrpc: '2.0',
                            id: message.id,
                            result: true
            ...
            case 'setBreakpoints':
                if (message.params && Array.isArray(message.params.breakpoints)) {
                    ...
                    this.emulatorState.breakpoints = message.params.breakpoints.map((bp) => {
     ...
     */
    setUse8BitRegistersOnly(use8BitOnly) {
