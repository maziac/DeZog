...
- [Kio](https://github.com/Megatokio) for the ZX81 and ZX Spectrum keyboard pictures. Please have a look into his ZX81/Spectrum emulator for macos: [zxsp](https://k1.spdns.de/Develop/Projects/zxsp/Distributions/) and [sources](https://github.com/Megatokio/zxsp).
