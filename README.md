...
- supports [ZEsarUX](https://github.com/chernandezba/zesarux) emulator (>= v9.2)
- supports [CSpect](http://www.cspect.org) emulator (>= v2.14.8)
...
- the [CSpect](http://www.cspect.org) emulator. At least version v2.14.3 is required.
